...
public class Sounds {
    ...
    public static final SoundEvent SASKATOON_PICK_1_EVENT = new SoundEvent(SASKATOON_PICK_1_ID);
    public static final Identifier SASKATOON_PICK_2_ID = Canadamod.getIdentifier("saskatoon_pick_2");
    public static final SoundEvent SASKATOON_PICK_2_EVENT = new SoundEvent(SASKATOON_PICK_2_ID);
    public static final Identifier SASKATOON_PICK_3_ID = Canadamod.getIdentifier("saskatoon_pick_3");
    public static final SoundEvent SASKATOON_PICK_3_EVENT = new SoundEvent(SASKATOON_PICK_3_ID);
