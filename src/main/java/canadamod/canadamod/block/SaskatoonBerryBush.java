...
public class SaskatoonBerryBush extends PlantBlock implements Fertilizable {
    ...
    //determines whether or not this block is finished growing
    //or, whether it still needs to be random ticked
    public boolean hasRandomTicks(BlockState state) {
        return !isFinishedGrowing(state);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        boolean canGrow = !isFinishedGrowing(state);
        ...
        //otherwise, give berries/unripe berries
            ...
            SoundEvent sound = switch (world.random.nextInt(3)) {
                case 1 -> Canadamod.SASKATOON_PICK_2_EVENT;
                case 2 -> Canadamod.SASKATOON_PICK_3_EVENT;
                default -> Canadamod.SASKATOON_PICK_1_EVENT;
            };
    ...
    public boolean isFinishedGrowing(BlockState state) {
